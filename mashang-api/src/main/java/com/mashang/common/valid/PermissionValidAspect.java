package com.mashang.common.valid;
...
import com.mashang.common.exception.PermissionValidException;
...
public class PermissionValidAspect {
	...
	@Pointcut("@annotation(com.mashang.common.valid.PermissionValid)")
	...
	public void before(JoinPoint joinPoint) {
		...
		permissionValid(url, rbacService.findMenuTreeByUserAccountId(user.getUserAccountId()));
	}
